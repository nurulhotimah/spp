                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <button class="btn btn-primary btn-sm" data-target="#tambahdata" data-toggle="modal"> <i class="fa fa-plus"></i> Tambah Kelas</button> <a href="<?= base_url('menu_admin/bunga/print_kelas') ?>" class="btn btn-danger btn-sm" target="_blank"> <i class="fa fa-print"></i> print</a> <a href="" style="margin-left: 830px;">Data Kelas</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-header">
                                                                <img src="<?= base_url() ?>assets/img/icon/love.ico" height="30px">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="<?php echo base_url() . 'menu_admin/kelas/tambah'; ?>" method="post">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <input type="text" name="id_kelas" class="form-control col-sm-6">
                                                                        </div>
                                                                        <div class="form-group row">
                                                                            <label class="col-sm-3">Nama Kelas</label>

                                                                            <input type="text" name="nama_kelas" class="form-control col-sm-6">
                                                                        </div>
                                                                        <div class=" form-group row">
                                                                            <label class="col-sm-3">Kompetensi Keahlian</label>

                                                                            <input type="text" name="kompetensi_keahlian" class="form-control col-sm-6">
                                                                        </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="card">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <footer class="text-center"><i class="fas fa-copyright"></i>SPP~NurulHotimah</footer>
