                ...
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="username" placeholder="Username" value="<?= set_value('name') ?>">
                                <?= form_error('username', '<small class="text-danger pl">', '</small>'); ?>
                            </div>
